...
export function About() {
    return (
        <section className="flex flex-col justify-center items-center pb-36 bg-white dark:bg-black text-[#4B5563] dark:text-[#D1D5DB]">
            ...
            <div className="w-[80%] lg:flex lg:flex-row lg:mt-8">

                <div className="flex justify-center mt-8 lg:w-[50%] lg:justify-start">
                    <img src={foto2} alt=""  className="w-[70%]"/>
                </div>

                <div className="mt-4 flex flex-col gap-4 lg:w-[50%] lg:mt-8 ">
